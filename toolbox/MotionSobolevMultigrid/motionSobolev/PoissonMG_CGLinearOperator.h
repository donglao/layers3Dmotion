#ifndef POISSONMG_CGLINEAROPERATOR
#define POISSONMG_CGLINEAROPERATOR

#include "CGLinearOperator.h"

template <class T>
class PoissonMG_CGLinearOperator : public CGLinearOperator<T> {
	public:
		int dim;
		int *sizes;
		int *increments;
	...
	public:
		PoissonMG_CGLinearOperator( int _dim, int *_sizes, int *_increments, 
